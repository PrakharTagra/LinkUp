    ...
    const fetchCatalog = async () => {
      ...
      try {
        ...
        const mappedCourses = (coursesData.courses || []).map(c => ({
          ...
          instructor: { name: c.instructor?.name || "Instructor", company: c.instructor?.company || "LinkUp Alumni" },
        ...
        const mappedSessions = (sessionsData.sessions || []).map(s => ({
          ...
          instructor: { name: s.instructor?.name || "Instructor", company: s.instructor?.company || "LinkUp Alumni" },
