      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <img src="/connect-logo.png" alt="LinkUp" style={{ height: 150, width: "auto", objectFit: "contain" }} />
          </div>
          ...
          <p style={{ fontSize: 13, color: "var(--text-3)" }}>© {new Date().getFullYear()} LinkUp</p>
        </div>
      </div>
          ...
          {step === 3 && (
            <div className="anim-fadeIn opacity-0">
              ...
              <div style={{
                ...
                LinkUp takes a <strong style={{ color: "var(--purple-light)" }}>platform commission</strong> on session, course, and workshop revenue. The rest is yours.
              </div>
