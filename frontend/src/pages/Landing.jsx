    ...
    <div style={{ position: "relative", background: "var(--bg)", color: "var(--text)", minHeight: "100vh", overflowX: "hidden" }}>
              ...
              <motion.div key="student" initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 30 }} transition={{ duration: 0.35 }} className="glass-card" style={{ padding: 36 }}>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 36, alignItems: "flex-start" }}>
                  <div style={{ flex: 1, minWidth: 240 }}>
                    ...
                    <p style={{ color: "var(--text-2)", fontSize: 14, lineHeight: 1.7, marginBottom: 20 }}>From personalised alumni feeds to membership-driven perks — LinkUp gives students an unfair advantage.</p>
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          ...
          <motion.div variants={staggerContainer(0.07)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-60px" }} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 18 }}>
            {[
              ...
              { name: "Priya Nair",    role: "Alumni · Meta · Ex-BITS Pilani", avatar: "P",  quote: "Earning ₹18,000/month from weekend sessions. LinkUp makes it super easy to host and manage everything.", accent: "var(--orange)" },
      ...
      <section style={{ position: "relative", zIndex: 1, padding: "72px 48px", background: "var(--bg-2)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          {[
            { q: "Is LinkUp free for students?",                        a: "Yes! Students can join, browse alumni, view the feed, and message connected alumni completely free. Paid features include premium mentorship sessions and courses." },
            ...
            { q: "Can I use LinkUp if my college isn't listed?",        a: "Absolutely! Any student or alumni can join regardless of college. College partnerships simply unlock additional benefits like offline sessions and exclusive discounts." },
      ...
      <section style={{ position: "relative", zIndex: 1, padding: "72px 48px", maxWidth: 1100, margin: "0 auto" }}>
        <Reveal style={{ textAlign: "center", marginBottom: 52 }}>
          ...
          <p style={{ fontSize: 15, color: "var(--text-2)", marginTop: 12, maxWidth: 520, margin: "12px auto 0" }}>Students on LinkUp are landing internships, full-time offers, and mentorship — faster than ever.</p>
        </Reveal>
        ...
        <motion.div variants={staggerContainer(0.1)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-60px" }} style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 40 }}>
          {[
            ...
            { Icon: IconRocket,    stat: "3 weeks",   label: "Avg. Time to First Lead", sub: "after joining LinkUp",      color: "var(--purple)" },
          ].map((item, i) => (
            <motion.div key={i} variants={fadeUp}>
      ...
      <footer style={{ borderTop: "1px solid var(--border)", padding: "20px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, position: "relative", zIndex: 1, background: "rgba(8,9,14,0.6)", backdropFilter: "blur(20px)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <span style={{ fontFamily: "Plus Jakarta Sans", fontWeight: 800, fontSize: 18, letterSpacing: "-0.03em", color: "#FFFFFF", lineHeight: 1.1 }}>LinkUp</span>
        ...
        <p style={{ fontSize: 13, color: "var(--text-3)" }}>© {new Date().getFullYear()} LinkUp. Bridging students & alumni across India.</p>
