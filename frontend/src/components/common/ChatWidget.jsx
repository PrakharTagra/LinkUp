...
import { AI_API_URL } from "../../config/urls.js";
...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState([
    {
      from: "bot",
      text: `Hi${user?.name ? ` ${user.name.split(" ")[0]}` : ""}! 👋 I'm **LinkUp AI** — your guide to this platform.\n\nI can help you explore features, find mentors, understand courses, and answer any question about LinkUp.`,
    },
  ]);
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Toggle LinkUp AI chat"
      >
      ...
      {open && (
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: "var(--text)", fontWeight: 700, fontSize: 13.5 }}>LinkUp AI</div>
          ...
          <div style={{
            ...
            <input
              ...
              placeholder="Ask anything about LinkUp..."
              style={{
